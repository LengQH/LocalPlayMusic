...
-(void)setCusFont:(UIFont *)cusFont{
    if (cusFont) {
        self.titleLabel.font=[cusFont fontWithSize:cusFont.pointSize*heightRatioWithAll];
//        NSLengLogLeng(@"传进来Button的大小:%f 最终字体的大小:%f",cusFont.pointSize,self.titleLabel.font.pointSize);
    }
}
@end
